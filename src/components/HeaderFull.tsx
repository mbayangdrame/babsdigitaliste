...
function HeaderFull({ 
  titre = "Portfolio", 
  paragraphe = "Créer des histoires grâce à des photos et des vidéos époustouflantes" 
}: {
  titre?: string;
  paragraphe?: string;
}) {
    ...
    return(
        ...
        <nav className="relative z-10 container mx-auto px-6 py-6">
          <div className="flex justify-between items-center">
            <div className="text-3xl tracking-wider"><img src={logo} alt="" />
              {/* <img src={logo} alt="" /> */}
              </div>
              <button 
              ...
              <Link to="/about" className="hover:text-[#009EAA] transition-colors">Apropos</Link>
        ...
        <div className={`relative z-10 container mx-auto px-6 h-[60vh] flex items-center justify-center w-full ${isMenuOpen ? 'mt-60' : ''}`}>
          <motion.div 
            initial="hidden"
            animate="visible"
            variants={fadeIn}
          ...
          >
            <h3 className="text-6xl font-bold mb-6 leading-tight text-center">
              {titre}
            </h3>
