        ...
        <div className="services-grid">
          <div className="service-card group">
            <div className="service-icon">
              <svg xmlns="http://www.w3.org/2000/svg" className='iconewhite group-hover:stroke-white' fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#009EAA">
          ...
          <div className="service-card group">
            <div className="service-icon">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" className='iconewhite group-hover:stroke-white' viewBox="0 0 24 24" strokeWidth={1.5} stroke="#009EAA">
    ...
    <section className="unique-experience">
      <div className="experience-container">
        <div className="experience-left">
          <img src="/img/site1.jpg" alt="Session photo avec guitariste" className="main-image" />
        ...
        <div className="experience-right">
          ...
          <img src="/img/pdg.jpg" alt="Session photo portrait" className="secondary-image" />
        </div>
      </div>
    </section>
