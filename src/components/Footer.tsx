      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-4">
            <li>
              <a href="/about" className="text-gray-400 hover:text-[#009EAA] flex items-center">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white">+221 77 124 84 27</p>
                <p className="text-[#fff] text-sm">Pour plus d'informations</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#009EAA]" viewBox="0 0 20 20" fill="currentColor">
